...
services:
  remnanode:
    volumes:
      ...
      - $XRAY_SERVICE_OVERRIDE:/opt/app/dist/src/modules/xray-core/xray.service.js:ro
...
write_xray_service_override() {
  log "Записываю override xray.service.js с persist-recovery после reboot/restart"
...
write_stats_service_override() {
  log "Записываю override stats.service.js с BBR conntrack fallback telemetry"
